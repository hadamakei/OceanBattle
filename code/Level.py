...
class Level:
    def __init__(self, window, name, game_mode):
        ...
        self.entity_list.extend(EntityFactory.get_entity('level1Bg'))  # Instancia nível do jogo
        self.entity_list.append(EntityFactory.get_entity('Player1'))  # Instancia jogador 1
